...
if mostrar_documentacion:
    st.markdown(
        """
        En esta práctica voy a usar cuatro conjuntos de datos.
        ...
        Los cuatro conjuntos tratan sobre : 'Evolución de la renta 16-29 años', 'Evolución de la edad de maternidad', 'Evolución de la edad de emancipación' y 'Evolución del precio de las viviendas' .
